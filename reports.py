...
def get_report_data(
    ...
    """Returns dynamic, fast live database rows for each report key (M-25: restricted to admins)."""
    ...
    # 10. Operational — AI Usage Analytics Report (Real Bedrock Usage, L-29)
        ...
        if usage_records:
            ...
            features = [
                "AI Brand Name Generation",
                "AI Brand Name Screening",
                "Side-by-Side Comparison & Stem Checks",
            ]
